	...
	$dj_member=new dj_member("*","id_member='$idm' AND email='$email'");//
	$old_imprint=$dj_member->GET_imprint();
	var_dump($old_imprint);
	...
	var_dump($ident_registration);
	$ident_Activation=$dj_member-> getIdentification($old_imprint,$identActivation);
	var_dump($ident_Activation);
	$ident_banning=$dj_member-> getIdentification($old_imprint,$identBan);
	var_dump($ident_banning);
	//****
